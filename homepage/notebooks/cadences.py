...
D = utils.get_dataset("distant_listening_corpus", corpus_release="v3.2")
package = D.inputs.get_package()
package_info = package._package.custom
git_tag = package_info.get("git_tag")
utils.print_heading("Data and software versions")
print("The Distant Listening Corpus: A modular infrastructure for the empirical study of (an)notated music version v3.2")
...
mean_composition_years = (
    hascadence_metadata.groupby(level="corpus")
    .composed_end.mean()
    .astype(int)
    .sort_values()
)
...
if phrases.index.nlevels != 3:
    raise ValueError(
        "Phrase metadata index must have corpus, piece, and phrase levels."
    )
